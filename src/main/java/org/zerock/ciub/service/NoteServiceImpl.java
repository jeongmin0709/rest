package org.zerock.ciub.service;

import lombok.RequiredArgsConstructor;
import lombok.extern.log4j.Log4j2;
import org.springframework.stereotype.Service;
import org.zerock.ciub.dto.NoteDTO;
import org.zerock.ciub.entity.Note;
import org.zerock.ciub.repository.NoteRepository;
...
public class NoteServiceImpl implements NoteService {
    ...
    public List<NoteDTO> getAllWithWriter(String writerEmail) {
        List<Note> noteList = noteRepository.getWithWriter(writerEmail);
